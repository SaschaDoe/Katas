...
using CSVTable.Infrastructure;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace CSVTableTests.AcceptanceTests
{
    [TestClass]
    public class CsvTableAcceptanceTests
    {
        private static IEnumerable<string> _oneLineTestInputCsv;
        private static IEnumerable<string> _nothingTestInput;
        ...
        {
            _nothingTestInput = CsvReader.ReadDataFrom(@"./Resources/Input_Nothing.csv");
        ...
        public void Nothing_When_NothingIsEntered()
        {
            ...
            var actualTablelizedData = csvTable.Tablelize(_nothingTestInput);
